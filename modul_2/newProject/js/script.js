window.addEventListener('DOMContentLoaded', () => {
  ...
  //  const div = nev MenuCard();
  //  div.render();
  //Когда объект используется только на месте то
  ...
  function showThanksModal(message) {
    ...
    thanksModal.innerHTML = `
      <div class="modal__content">
        ...
        <div class="modal__titele">${message}</div>
      </div>
    `;
  ...
  const slides = document.querySelectorAll('.offer__slide'),
    ...
    slideWripper = document.querySelector('.offer__slider-wrapper'),
    slidesField = document.querySelector('.offer__slider-inner'),
    width = window.getComputedStyle(slideWripper).width;
  ...
  slideWripper.style.overflow = 'hidden';
  ...
  dots.forEach(dot => {
    dot.addEventListener('click', (e) => {
      const slideTo = e.target.getAttribute('data-style-to');
  ...
  function initLocalSetings(selector, activeClass) {
    ...
    elements.forEach(elem => {
      ...
      if (elem.getAttribute('date-ratio') === localStorage.getItem('ratio')) {
        elem.classList.add(activeClass);
      }
    })
  }
  ...
  function getStaticInfomation(selector, activeClass) {
    ...
    elements.forEach(elem => {
      elem.addEventListener('click', (e) => {
        if (e.target.getAttribute('date-ratio')) {
          ratio = e.target.getAttribute('date-ratio')
          localStorage.setItem('ratio', e.target.getAttribute('date-ratio'));
        } else {
